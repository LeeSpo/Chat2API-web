  ...
  glm: [
    {
      ...
      description: 'After logging in to chatglm.cn, copy chatglm_refresh_token from Cookies',
  ...
  minimax: [
    {
      ...
      tokenType: 'token',
      label: 'Token (realUserID+JWT)',
      placeholder: 'Format: realUserID+JWT or just the JWT',
      description: 'Obtain after logging in to agent.minimaxi.com. Local Storage _token is the JWT; realUserID is optional.',
