...
import { auth, setManagementSecret } from '@/web-admin-api'
...
export function PasswordSettings() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.secret) {
        setManagementSecret(result.secret)
      }
      setSuccess(result?.rotated ? t('password.successRotated') : t('password.success'))
      reset()
    } catch (err) {
