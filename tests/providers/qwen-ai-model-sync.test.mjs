...
const providerCheckerSource = fs.readFileSync('backend/providers/checker.ts', 'utf8')
const modelSyncSource = fs.readFileSync('backend/providers/modelSync.ts', 'utf8')
const providerCardSource = fs.readFileSync('frontend/src/components/providers/ProviderCard.tsx', 'utf8')
